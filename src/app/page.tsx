...
import DemoVideoGenerator from "@/components/dashboard/demo-video-generator";
import Logo from "@/components/logo"
import { ScanFace, FileText, MicVocal, Video, Wand } from "lucide-react"
      ...
      <main className="flex flex-1 flex-col items-center gap-4 p-4 md:gap-8 md:p-8">
        <div className="w-full max-w-6xl">
          ...
          <Tabs defaultValue="image" className="w-full">
            <TabsList className="grid w-full grid-cols-5 h-14 rounded-lg p-2">
              ...
              <TabsTrigger value="demo" className="flex items-center gap-2 text-base h-full">
                <Wand className="h-5 w-5" /> Demo Video
              </TabsTrigger>
            </TabsList>
